...
- The Q&A endpoint is single-turn only in v1 — each `POST /qa` request is
  stateless and independent; no conversation history is maintained across requests.
  Multi-turn support and answer feedback are out of scope for v1.
